...
class Layouts
{
	...
	public function loadpdf($view_name, $params = array(), $layout = 'pdf_print',$return = false){
		...
		if($return)
			return $this->CI->load->view('layouts/' . $layout, array(
	...
	public function profile($view_name, $params = array(), $layout = 'profile')
	{
		$rendered_view = $this->CI->load->view($view_name, $params, TRUE);
	...
	public function pdf($view_name, $params = array(), $layout = 'pdf')
	{
		$rendered_view = $this->CI->load->view($view_name, $params, TRUE);
