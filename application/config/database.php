...
$db['apedev']['database'] = 'APEDEV';
$db['apedev']['dbdriver'] = 'oci8';
$db['apedev']['dbprefix'] = '';
$db['apedev']['pconnect'] = TRUE;
$db['apedev']['db_debug'] = TRUE;
$db['apedev']['cache_on'] = FALSE;
$db['apedev']['cachedir'] = '';
$db['apedev']['char_set'] = 'utf8';
$db['apedev']['dbcollat'] = 'utf8_general_ci';
$db['apedev']['swap_pre'] = '';
...
$db['intelisis']['database'] = "APE";
$db['intelisis']['dbdriver'] = "odbc";
$db['intelisis']['dbprefix'] = "";
$db['intelisis']['pconnect'] = FALSE;
$db['intelisis']['db_debug'] = TRUE;
$db['intelisis']['cache_on'] = FALSE;
$db['intelisis']['cachedir'] = "";
$db['intelisis']['char_set'] = "utf8";
$db['intelisis']['dbcollat'] = "utf8_general_ci";
