...
<div class="wrapList">
  ...
  <div class="wrapListFormThree" id="contentEva">
    ...
    <? $valida = $this->evaluacion_model->validaPermisosEvaluaciones($usuarioSesion['usuarioID'],$this->uri->segment(3));?>
    ...
    <table class="infoEva">
      ...
      <tbody>
      <? $pregunta = $this->evaluacion_model->preguntasCategorias($row->categoria,$this->uri->segment(5));?>
      <? foreach ($pregunta as $var): ?>
      <tr>
        <!--- Primer Segmento--->
        <td><em><?=$var->pregunta;?></em></td>
        <? $resp = $this->evaluacion_model->respuestasPorPregunta($var->preguntaID,$this->uri->segment(3));?>
