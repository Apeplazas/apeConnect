<div id="mainTit">
<h3>Creacion de de usuario.</h3>
</div>

<div class="loader" style="display:none;"></div>
<div class="wrapList">
<form class="form-horizontal" method="post" id="creusu" action="<?=base_url();?>tempciri/DarAlta" enctype="multipart/form-data">
...
<div class="wrapListForm" id="wrapLiistForm1">
	<table>
		...
		<tr>
			...
			<td colspan="3">
				<input type="text" class="bigInp uppercase blockClear" name="contrasenia" id="contrasenia" required>
			</td>
		</tr>
		<tr>
