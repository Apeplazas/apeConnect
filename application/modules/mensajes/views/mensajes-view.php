...
<div id="wrapTableNot">
<?php if(!empty($mensajes_admin) || !empty($mensajes_usuario)):?>
	<ul>
		<?php foreach($mensajes_admin as $mensaje):?>
			...
			<p class="notGen"><em>Dia y Hora: <?=$mensaje->date;?></em></p>
			  ...
			  <a class="wrapText" href="<?=$mensaje->url;?>" class="notificaciones" title="<?=$mensaje->id;?>-role">
		...
		<?php foreach($mensajes_usuario as $mensaje):?>
			<li <?php if($mensaje->leido == 0):?>class="noLeido" <?php endif;?>>
			  ...
			  <a href="<?=$mensaje->url;?>" class="wrapText" title="<?=$mensaje->id;?>-usuario">
			    <p class="notMain"><?=$mensaje->mensaje;?></p>
			    <p class="notGen"><em>Dia y Hora: <?=$mensaje->date;?></em></p>
			  </a>
			</li>
