	...
	function valida()
	{
		...
		if ($u && !isset($u['error'])){
			...
			$data['usuario'] = array(
				...
				'numeroEntradasGeneral'          => $u[0]->numeroEntradasGeneral,
				'numeroEntradasProyectos'          => $u[0]->numeroEntradasProyectos,
				'numeroEntradasProveedores'          => $u[0]->numeroEntradasProveedores,
				'numeroEntradasCotizaciones'          => $u[0]->numeroEntradasCotizaciones,
				'numeroEntradasSettings'          => $u[0]->numeroEntradasSettings,
				'numeroEntradasPlanogramas'          => $u[0]->numeroEntradasPlanogramas,
				'numeroEntradasProspectos'          => $u[0]->numeroEntradasProspectos,
				'numeroEntradasRenovaciones'          => $u[0]->numeroEntradasRenovaciones,
				'numeroEntradasRH'          => $u[0]->numeroEntradasRH,
				'numeroEntradasTempciri'          => $u[0]->numeroEntradasTempciri,
				'numeroEntradasEvaluacionesTwo'          => $u[0]->numeroEntradasEvaluacionesTwo,
