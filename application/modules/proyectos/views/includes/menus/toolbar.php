...
<ul>
	...
	<li>
		<a class="botones fancy" id="fancy" href="#addProyect" ><img src="<?=base_url()?>assets/graphics/agregarProyecto.png" alt="Agregar Proyecto" /><em class="agProy">Agregar proyecto</em></a>
	</li>
</ul>
