  ...
  <table>
		  ...
		  <tr>
			...
			<tr>
				...
				<td>
					<select class='selBig' id='selpiso<?=$i?>' disabled="disabled" title="No tiene los permisos para modificar este campo">
...
for(i=1;i<=val;i++){
						...
						window.location.replace("http://www.apeplazas.com/apeConnect/planogramas/predios");
